...
namespace BinarySearch
{
    class Program
    {
        ...
        //to specify in which half of the array we should be searching(the array is sorted),
        //and we do that until we find x or we can't split array anymore
        {
            if (left < right)
            {
                ...
                if (array[middle] == x)
                {
                    Console.WriteLine("Poisition: " + (middle + 1));
                    return true;
                }
        ...
        static void Main(string[] args)
        {
            ...
            final = BS(array, 0, array.Length, x);
            if (final == true)
